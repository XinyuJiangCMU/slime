...
source "${REPO_ROOT}/scripts/models/qwen3-235B-A22B.sh"
...
CKPT_ARGS=(
   --hf-checkpoint ${MODEL_DIR}/Qwen3-235B-A22B # huggingface-cli download Qwen/Qwen3-235B-A22B
...
ray start --head --node-ip-address ${MASTER_ADDR} --port 6380 --num-gpus 8 \
            --disable-usage-stats \
