...
source "${REPO_ROOT}/scripts/models/qwen3-4B-Instruct-2507.sh"
...
CKPT_ARGS=(
   --hf-checkpoint ${MODEL_DIR}/Qwen3-4B-Instruct-2507 # huggingface-cli download Qwen/Qwen3-4B-Instruct-2507
   --ref-load ${MODEL_DIR}/Qwen3-4B-Instruct-2507_torch_dist
   # --load ${MODEL_DIR}/Qwen3-4B-Instruct-2507_slime/
   --save ${MODEL_DIR}/Qwen3-4B-Instruct-2507_slime/
   --save-interval 20
)
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3-4b-instruct-eval
